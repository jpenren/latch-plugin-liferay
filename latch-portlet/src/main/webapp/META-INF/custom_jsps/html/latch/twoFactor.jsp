	...
	<div class="two-factor__wrapper">
		...
		<div class="two-factor__content">
			<form method="post">
				...
				<input type="password" name="--token-value" value="" maxlength="6" class="two-factor__token" autofocus="autofocus" ></input>
				<input type="submit" value="OK" class="two-factor__send"></input>
